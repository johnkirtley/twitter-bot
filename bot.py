...
search_terms = ["nft", "bayc", "bored ape yacht club", "bored mummy waking up",
                "wicked ape bone club", "nftcommunity", "mayc", "mutant ape yacht club", "mutant ape", "doge pound", "cryptopunk"]
...
class MyStreamListener(tweepy.StreamListener):
    ...
    def on_status(self, tweet):
        ...
        if not status.favorited and status.favorite_count > 20:
